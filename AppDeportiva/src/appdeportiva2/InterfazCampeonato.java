...
//import javaapplication2.Campeonato;
...
//    //-----------------------------------------------------------------
//    /**
//     * Construye la interfaz e inicializa el campeonato indicando que no se ha
//     * cargado la información de ningún archivo
//     */
...
//    //-----------------------------------------------------------------
//    /**
//     * Muestra el diálogo usado para registrar el resultado de un partido. Este
//     * diálogo solo se despliega si el campeonato ya ha sido inicializado
//     */
...
//                cons = new Campeonato(archivoCampeonato);
...
////                        calculosEquipo[ 3] = "" + cons.consulta(g, i);
//            calculosEquipo[ 4] = "" + campeonato.darPartidosEmpatados(i);
//
////            calculosEquipo[ 3] = "" + cons.consulta(em, i);
